	...
	return (
		<GeneralLayout>
			<div className="w-full flex flex-col justify-center dark gap-8 py-0 md:py-10 items-center px-6 md:px-20">
				<div className="border p-2 w-full bg-[#c7cc6643] md:mx-0 !border-amber-100">
					<div className="border py-8 md:py-16 md:p-8 bg-[#cb4ed943] bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-10 !border-amber-500 w-full">
